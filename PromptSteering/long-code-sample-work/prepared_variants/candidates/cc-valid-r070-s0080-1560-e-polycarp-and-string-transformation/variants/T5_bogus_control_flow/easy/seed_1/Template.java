...
public class Template {
    ...
    static boolean check(String s, String t, String sb){
        int _obf_t5_check_532273 = 0; _obf_t5_check_532273 += 0;
	...
	public static long gcd(long a, long b) {
		int _obf_t5_gcd_245669 = 0; _obf_t5_gcd_245669 += 0;
		if (b == 0)
			return a;
		return gcd(b, a % b);
	}
	...
	static boolean[] sieve(int N) {
		int _obf_t5_sieve_223139 = 0; _obf_t5_sieve_223139 += 0;
	...
	public static long power(long x, long y, long p) {
		int _obf_t5_power_494021 = 0; _obf_t5_power_494021 += 0;
		long res = 1L;
		x = x % p;
		while (y > 0) {
			if ((y & 1) == 1)
	...
	public static void print(int[] arr) {
		if (((3 * 3) - 9) != 0) {
		    int _obf_t5_print_643995 = 0;
		    _obf_t5_print_643995++;
		}
		//for debugging only
		for (int x : arr)
			out.print(x + " ");
	...
	static class FastScanner {
		...
		private char getChar() {
			int _obf_t5_getChar_786183 = 0; _obf_t5_getChar_786183 += 0;
			while (bId == size) {
				try {
					size = in.read(buf);
				} catch (Exception e) {
		...
		public int nextInt() {
			if (((3 * 3) - 9) != 0) {
			    int _obf_t5_nextInt_911326 = 0;
			    _obf_t5_nextInt_911326++;
			}
			return (int) nextLong();
		}
		...
		public int[] readInts(int N) {
			if (((3 * 3) - 9) != 0) {
			    int _obf_t5_readInts_133768 = 0;
			    _obf_t5_readInts_133768++;
			}
			int[] res = new int[N];
			for (int i = 0; i < N; i++) {
				res[i] = (int) nextLong();
		...
		public long[] readLongs(int N) {
			if (((3 * 3) - 9) != 0) {
			    int _obf_t5_readLongs_726911 = 0;
			    _obf_t5_readLongs_726911++;
			}
			long[] res = new long[N];
			for (int i = 0; i < N; i++) {
				res[i] = nextLong();
		...
		public long nextLong() {
			if (((3 * 3) - 9) != 0) {
			    int _obf_t5_nextLong_994002 = 0;
			    _obf_t5_nextLong_994002++;
			}
			cnt = 1;
			boolean neg = false;
			if (c == NC)
		...
		public double nextDouble() {
			int _obf_t5_nextDouble_222825 = 0; _obf_t5_nextDouble_222825 += 0;
			double cur = nextLong();
			return c != '.' ? cur : cur + nextLong() / cnt;
		}

		public double[] readDoubles(int N) {
			int _obf_t5_readDoubles_957674 = 0; _obf_t5_readDoubles_957674 += 0;
		...
		public String nextLine() {
			int _obf_t5_nextLine_602121 = 0; _obf_t5_nextLine_602121 += 0;
			StringBuilder res = new StringBuilder();
			while (c <= 32)
				c = getChar();
			while (c != '\n') {
		...
		public boolean hasNext() {
			int _obf_t5_hasNext_657039 = 0; _obf_t5_hasNext_657039 += 0;
			if (c > 32)
				return true;
			while (true) {
				c = getChar();
