...
public class C_f4b8faf6 {
    ...
    public static void main(String[] args) {
        ...
        int _obf_t5_main_955964_h = 0;
        for (int _i = 0; _i < 2; _i++) {
            _obf_t5_main_955964_h += _i;
        }
        if ((_obf_t5_main_955964_h - 1) < 0) {
    ...
    public static int binarySearch(int[] sortedArray, int key, int low, int high) {
        ...
        int _obf_t5_binarySearch_876875_h = 0;
        for (int _i = 0; _i < 2; _i++) {
            _obf_t5_binarySearch_876875_h += _i;
        }
        if ((_obf_t5_binarySearch_876875_h - 1) < 0) {
