...
public class C_468abf90 {
    ...
    public static void main(String[] args) {
        ...
        int _obf_t5_main_42238_h = (1 ^ 1);
        if (_obf_t5_main_42238_h != 0) {
            _obf_t5_main_42238_h += 1;
        }
    ...
    public static int[] bogo(int[] field) {
        ...
        int _obf_t5_bogo_101880_h = (1 ^ 1);
        if (_obf_t5_bogo_101880_h != 0) {
            _obf_t5_bogo_101880_h += 1;
        }
        Random r = new Random();
