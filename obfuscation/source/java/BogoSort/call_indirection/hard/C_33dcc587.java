...
private static int[] _obf_t8_bogo_328917(int[] field) {
        return _obf_t8_bogo_328917_inner(field);
    }

    private static int[] _obf_t8_bogo_328917_inner(int[] field) {
        return bogo(field);
    }

    private static boolean _obf_t8_isFinished_590318(int[] field) {
        return _obf_t8_isFinished_590318_inner(field);
    }

    private static boolean _obf_t8_isFinished_590318_inner(int[] field) {
