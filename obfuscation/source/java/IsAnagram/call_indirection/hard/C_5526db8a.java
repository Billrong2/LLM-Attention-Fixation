...
private static String _obf_t8_sort_603389(String word) {
        return _obf_t8_sort_603389_inner(word);
    }

    private static String _obf_t8_sort_603389_inner(String word) {
        return sort(word);
    }

    private static boolean _obf_t8_isAnagram_941909(String word1, String word2) {
        return _obf_t8_isAnagram_941909_inner(word1, word2);
    }

    private static boolean _obf_t8_isAnagram_941909_inner(String word1, String word2) {
