...
public class C_a10f6c29 {
    ...
    public static void main(String[] args) {
        ...
        int _obf_t5_main_602532_h = (1 ^ 1);
        if (_obf_t5_main_602532_h != 0) {
            _obf_t5_main_602532_h += 1;
        }
    ...
    public static String sort(String word) {
        ...
        int _obf_t5_sort_988241_h = (1 ^ 1);
        if (_obf_t5_sort_988241_h != 0) {
            _obf_t5_sort_988241_h += 1;
        }
    ...
    public static boolean isAnagram(String word1, String word2) {
        int _obf_t5_isAnagram_926375 = 0; _obf_t5_isAnagram_926375 += 0;
