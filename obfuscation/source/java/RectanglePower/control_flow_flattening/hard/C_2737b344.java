...
class C_2737b344 {
    ...
    public static void main(String[] args) {
        ...
        if ((_obf_t6_state_main_562964 ^ 1) < 0) {
            int _obf_t6_guard_562964 = 0;
            _obf_t6_guard_562964 += 0;
        }
        do {
                    System.out.println();
    ...
    public static int power(int base, int exponent) {
        ...
        if ((_obf_t6_state_power_730668 ^ 1) < 0) {
            int _obf_t6_guard_730668 = 0;
            _obf_t6_guard_730668 += 0;
        }
        do {
                    if (exponent == 0) {
                    return 1;
