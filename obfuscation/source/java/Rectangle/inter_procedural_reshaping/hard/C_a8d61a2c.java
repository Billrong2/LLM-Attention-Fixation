...
public class C_a8d61a2c {
    private final int x1;
    private final int y1;
    private final int x2;
    private final int y2;

    public C_a8d61a2c(int x1, int y1, int x2, int y2) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
    ...
    public static void main(String[] args) {
        ...
        C_a8d61a2c rect1 = new C_a8d61a2c(0, 0, 10, 10);
        System.out.println(rect1.area());
        C_a8d61a2c rect2 = new C_a8d61a2c(5, 5, 10, 10);
