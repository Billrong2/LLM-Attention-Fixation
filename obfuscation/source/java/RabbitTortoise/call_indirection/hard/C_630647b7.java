...
private static int _obf_t8_rabbitTortoise_908192(int[] number_field) {
        return _obf_t8_rabbitTortoise_908192_inner(number_field);
    }

    private static int _obf_t8_rabbitTortoise_908192_inner(int[] number_field) {
        return rabbitTortoise(number_field);
    }
}
