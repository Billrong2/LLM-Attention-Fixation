...
private static int _obf_t8_binaryToDecimal_175510(String str, int position) {
        return _obf_t8_binaryToDecimal_175510_inner(str, position);
    }

    private static int _obf_t8_binaryToDecimal_175510_inner(String str, int position) {
